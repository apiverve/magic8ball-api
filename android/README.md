...
```gradle
dependencies {
    implementation 'com.github.apiverve:magic8ball-api:1.1.13'
}
```
...
```java
import com.apiverve.magic8ball.Magic8-BallAPIClient;
import com.apiverve.magic8ball.APIResponse;
import com.apiverve.magic8ball.APIException;

// Initialize the client
Magic8-BallAPIClient client = new Magic8-BallAPIClient("YOUR_API_KEY");

try {
    // Prepare query parameters
    Map<String, Object> parameters = new HashMap<>();
    parameters.put("question", "Will it rain today?");
...
For detailed API documentation, visit: [https://docs.apiverve.com/ref/magic8ball](https://docs.apiverve.com/ref/magic8ball)
...
- **Documentation:** [https://docs.apiverve.com/ref/magic8ball](https://docs.apiverve.com/ref/magic8ball)
- **Issues:** [GitHub Issues](https://github.com/apiverve/magic8ball-api/issues)
