// Package magic8ball provides a Go client for the Magic 8-Ball API.
//
// For more information, visit: https://apiverve.com/marketplace/magic8ball?utm_source=go&utm_medium=readme
package magic8ball
...
const (
	baseURL        = "https://api.apiverve.com/v1/magic8ball"
	defaultTimeout = 30 * time.Second
)

// Client is the Magic 8-Ball API client.
type Client struct {
	apiKey     string
	httpClient *resty.Client
}

// NewClient creates a new Magic 8-Ball API client.
...
// Execute makes a request to the Magic 8-Ball API with typed parameters.
//
...
//   - question: string - Your question for the Magic 8-Ball (optional)
