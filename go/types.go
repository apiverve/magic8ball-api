...
// Request contains the parameters for the Magic 8-Ball API.
//
// Parameters:
//   - question: string - Your question for the Magic 8-Ball (optional)
type Request struct {
	Question string `json:"question,omitempty"` // Optional
}
...
// ResponseData contains the data returned by the Magic 8-Ball API.
