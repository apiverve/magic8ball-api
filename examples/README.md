# Magic 8-Ball API - Examples

This folder contains example code for using the Magic 8-Ball API across different platforms.
...
response = requests.get('https://api.apiverve.com/v1/magic8ball',
  headers={'x-api-key': 'YOUR_API_KEY'})
data = response.json()
```
...
var response = await client.GetAsync("https://api.apiverve.com/v1/magic8ball");
var data = await response.Content.ReadAsStringAsync();
```

## 📚 Documentation

- **API Reference:** [https://docs.apiverve.com/ref/magic8ball](https://docs.apiverve.com/ref/magic8ball)
