/*
 * Magic 8-Ball API - Basic Usage Example
 *
 * This example demonstrates the basic usage of the Magic 8-Ball API.
 * API Documentation: https://docs.apiverve.com/ref/magic8ball
 */
    ...
    class Magic8-BallExample
    {
        ...
        static async Task<JsonDocument> CallMagic8-BallAPI()
        {
            try
            {
                ...
                // Query parameters
                var queryParams &#x3D; new Dictionary&lt;string, string&gt; { [&quot;question&quot;] &#x3D; &quot;Will it rain today?&quot; };
        ...
        {
            Console.WriteLine("📤 Calling Magic 8-Ball API...\n");

            var result = await CallMagic8-BallAPI();
