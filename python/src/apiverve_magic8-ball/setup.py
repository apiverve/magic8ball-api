...
setup(
    ...
    project_urls={
        ...
        'Documentation': 'https://docs.apiverve.com/ref/magic8ball',
        'Source': 'https://github.com/apiverve/magic8ball-api',
        'Bug Tracker': 'https://github.com/apiverve/magic8ball-api/issues'
    },
    classifiers=[
