...
/**
 * Client for the Magic 8-Ball API
 *
 * @example Basic usage
 * ```php
 ...
 * ```
 *
 * @see https://apiverve.com/marketplace/magic8ball?utm_source=php&utm_medium=readme
 */
class Client
{
    private const BASE_URL = 'https://api.apiverve.com/v1/magic8ball';
    ...
    {
        if ($this->debug) {
            echo "[APIVerve\Magic8ballClient] {$message}\n";
        }
    }
}
